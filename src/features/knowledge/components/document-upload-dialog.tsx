...
interface DocumentUploadDialogProps {
  onUpload: (params: { title: string; content: string; fileName?: string; fileType: "pdf" | "docx" | "txt" | "md"; fileSize?: number }) => Promise<void>;
...
export function DocumentUploadDialog({ onUpload, children }: DocumentUploadDialogProps) {
  ...
  async function handleUpload() {
    ...
    setUploading(true);
    try {
      const ext = selectedFile.name.split(".").pop()?.toLowerCase() as "pdf" | "docx" | "txt" | "md";
