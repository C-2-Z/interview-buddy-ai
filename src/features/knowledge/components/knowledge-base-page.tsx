...
import { useQaSessions, useCreateQaSession } from "../hooks/use-qa-sessions";
...
export function KnowledgeBasePage() {
  ...
  const activeTab: KnowledgeTab = search.tab;
  ...
  const filteredDocs = activeBrainId
    ? documents.filter((d) => brainDocIds.includes(d.id))
    : documents;
  ...
  return (
    <div className="flex h-full flex-col">
      {/* 知识库选择器 */}
      <BrainSelector activeBrainId={activeBrainId} onBrainChange={handleBrainChange} />
