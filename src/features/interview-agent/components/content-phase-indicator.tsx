 ...
 import type { AgentRoleId, AgentSnapshot, AgentMode, AgentWorkspace } from "../types";
 ...
 export function ContentPhaseIndicator({
   ...
   const currentPhase = useMemo(
     ...
     [snapshot.mode, snapshot.currentQuestionIndex, snapshot.currentRole, workspace.config.questionCount],
   );
